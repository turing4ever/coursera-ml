...
for i=1:m
    ...
    yy = Y(i,:)'; %10,1
    d3 = a3-yy; %10,1
    d2 = t2'*d3.*sigmoidGradient(z2);%25,1

    Delta2 = Delta2 + d3*a2';%10,25
    Delta1 = Delta1 + d2*a1';%25,400
end
...
Theta1_grad = Theta1_grad + [zeros(num_labels,1) lambda*Theta1(:, 2:end)/m];
